...
function editLerningResultModal(button){
    ...
    var ajaxUrl = base_url+'EditLearningResult/getLearningResultById/' + idLearningResult;
...
function postPutExecution(url, dataFormLR, modalName, formModal){
    ...
    var formData = new FormData(dataFormLR);
...
function deleteLearningResult(deleteButton){
    var code = deleteButton.getAttribute('lr');
    swal({
